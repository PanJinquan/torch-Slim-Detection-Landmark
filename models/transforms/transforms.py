...
if __name__ == "__main__":
    ...
    image_path = "/home/dm/panjinquan3/FaceDetector/Ultra-Light-Fast-Generic-Face-Detector-1MB/data/person/4.jpg"
    ...
    tans_fun = RandomMirror()
    # tans_fun = RandomSampleCrop_v2()
    for i in range(100):
        print(i)
        dst_image, boxes, classes = tans_fun(src_image, src_boxes.copy(), classes)
        dst_image = dst_image.copy()
        dst_image = image_processing.draw_image_boxes(dst_image, boxes)
