...
def match_landms(threshold, truths, priors, variances, labels, landms, loc_t, conf_t, landm_t, idx):
...
def encode(matched, priors, variances):
    ...
    # dist b/t match_landms center and prior's center
    g_cxcy = (matched[:, :2] + matched[:, 2:]) / 2 - priors[:, :2]
    # encode variance
    g_cxcy /= (variances[0] * priors[:, 2:])
    # match_landms wh / prior wh
