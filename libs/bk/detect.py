...
from models.backbone.net_rfb import RFBLandm
...
parser.add_argument('--priors_type', default="face", help='Backbone network mobile0.25 or slim or RFB')
...
if __name__ == '__main__':
    ...
    # testing begin
    for i in range(100):
        image_path = "../../data/img/sample.jpg"
        ...
        # priorbox = PriorBox(cfg, input_size=(im_height, im_width))
        # priors = priorbox.forward()
        prior_boxes = PriorBox(input_size, priors_type=args.priors_type)
        priors=prior_boxes.priors
